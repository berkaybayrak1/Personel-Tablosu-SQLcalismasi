...
namespace WindowsFormsApp4
{
    public partial class FrmAnaForm : Form
    {
        ...
        {
            this.table_1TableAdapter.Fill(this.personel_veri_tabaniDataSet2.Table_1);
        }
        ...
        private void bnGÜNCELLE_Click(object sender, EventArgs e)
        {
            baglanti.Open();
        ...
        private void btnİSTATİKLER_Click(object sender, EventArgs e)
        {
